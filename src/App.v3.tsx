  ...
  <section className="bg-navy py-20 md:py-28 relative overflow-hidden">
    ...
    <div className="max-w-3xl mx-auto px-6 md:px-12 relative text-center z-[5]">
      <ScrollReveal
        ...
        textClassName="text-[clamp(1.05rem,2vw,1.25rem)] text-white/85 leading-[1.75] max-w-2xl mx-auto block"
      >
    ...
    <div className="min-h-screen bg-[#faf7f3]">
      ...
      <main className="max-w-3xl mx-auto px-5 py-12 md:py-16">
        ...
        <Section num="2" title="Организатор">
          ...
          <P>E-mail для обращений: roman@dusenko.ru</P>
        </Section>
        ...
        <Section num="4" title="Стоимость и порядок оплаты">
          ...
          <P>Участнику доступна оплата в рассрочку через сервис «Prodamus Частями» — условия и порядок изложены в разделе 4а настоящей Оферты.</P>
        </Section>

        <Section num="4а" title="Порядок оплаты в рассрочку">
          <p className="pl-4 font-medium text-[#2c1f14]">1. Оплата в рассрочку</p>
          {[
            '1.1. Согласно условиям настоящей оферты Продавец вправе предоставить Покупателю возможность оплатить стоимость оказываемых услуг в рассрочку.',
            '1.2. Покупатель осуществляет оплату в рассрочку непосредственно в пользу Продавца (в случае если рассрочка предоставляется Продавцом), без привлечения оператора сервиса рассрочки, без привлечения кредитных организаций, без предоставления Покупателю кредита или займа и без возникновения у Покупателя обязательств по возврату кредита или займа.',
            '1.3. Оплата в рассрочку может предоставляться Покупателю: непосредственно Продавцом; с использованием Сервиса Prodamus; с использованием иных сервисов, привлекаемых Продавцом. В случае предоставления рассрочки непосредственно Продавцом подтверждение условий рассрочки и техническое обеспечение приёма и (при наличии согласия Покупателя) рекуррентных списаний платежей осуществляются с использованием Сервиса Prodamus.',
            '1.4. Способ предоставления рассрочки определяется Продавцом и доводится до сведения Покупателя при оформлении заказа. В случае если для выбранного способа оплаты рассрочка Продавцом не предоставляется либо не может быть предоставлена, оплата осуществляется Покупателем в полном объёме единовременно.',
            '1.5. Сервис Prodamus (в случае предоставления рассрочки непосредственно Продавцом) выполняет исключительно функции по техническому обеспечению приёма платежей и рекуррентных списаний и не предоставляет Покупателю сервиса рассрочки или оплату в рассрочку, кредит или заём. При использовании иных сервисов рассрочки их функции и условия взаимодействия с Покупателем определяются правилами соответствующих сервисов.',
            '1.6. Условия оплаты в рассрочку, такие как: срок рассрочки, количество платежей, периодичность платежей, размер ежемесячного платежа — доводятся до сведения Покупателя при оформлении заказа и отображаются в интерфейсе соответствующего сервиса (в том числе Сервиса Prodamus) на платёжной странице при выборе оплаты в рассрочку.',
            '1.7. Заключая договор на условиях настоящей оферты, Покупатель предоставляет Продавцу своё согласие со всеми изложенными в настоящей оферте условиями оплаты в рассрочку, включая условия, сформированные при оформлении заказа и отображаемые в интерфейсе соответствующего сервиса, используемого для оформления рассрочки (в том числе Сервиса Prodamus).',
          ].map((t, i) => <p key={i} className="pl-4 border-l border-brown/15 text-[0.92rem] leading-relaxed text-[#3d2e21]/80">{t}</p>)}

          <p className="pl-4 font-medium text-[#2c1f14] mt-4">2. Возврат денежных средств</p>
          {[
            '2.1. В случае расторжения договора, отказа Покупателя от услуг либо возврата денежных средств осуществляется Продавцом в порядке, установленном законодательством Российской Федерации и условиями настоящей оферты.',
            '2.2. При оплате в рассрочку возврату подлежит сумма денежных средств, фактически уплаченная Покупателем на момент расторжения договора.',
          ].map((t, i) => <p key={i} className="pl-4 border-l border-brown/15 text-[0.92rem] leading-relaxed text-[#3d2e21]/80">{t}</p>)}

          <p className="pl-4 font-medium text-[#2c1f14] mt-4">3. Ответственность сторон</p>
          {[
            '3.1. Продавец самостоятельно определяет условия предоставления рассрочки и несёт ответственность за их соответствие законодательству Российской Федерации.',
            '3.2. Покупатель несёт ответственность за соблюдение графика платежей, установленного Продавцом либо соответствующим сервисом рассрочки.',
            '3.3. Сервис Prodamus (в случае предоставления рассрочки непосредственно Продавцом) не несёт ответственности за неисполнение или ненадлежащее исполнение обязательств Продавца перед Покупателем, включая обязательства, связанные с возвратом денежных средств, качеством услуг или исполнением условий рассрочки Покупателем или Продавцом.',
          ].map((t, i) => <p key={i} className="pl-4 border-l border-brown/15 text-[0.92rem] leading-relaxed text-[#3d2e21]/80">{t}</p>)}
        </Section>
