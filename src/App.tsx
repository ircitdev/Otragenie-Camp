      ...
      <div className="relative z-10 max-w-[72rem] mx-auto px-6 text-center">
        ...
        <Reveal delay={2.9}>
            <div className="flex gap-4 justify-center flex-wrap mb-9">
              <span className="px-5 py-2 rounded-full border border-white/30 text-white/80 text-[0.78rem] tracking-[0.03em]">
              10 мест в группе
            </span>
            <span className="px-5 py-2 rounded-full border border-white/30 text-white/80 text-[0.78rem] tracking-[0.03em]">
              Красная Поляна
    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12">
      ...
      <div className="grid lg:grid-cols-[1fr_340px] gap-16 items-start">
        ...
        <aside className="lg:sticky lg:top-28">
          ...
          <p className="font-serif italic text-[0.85rem] text-text-dark-muted leading-snug">Выездной терапевтический кэмп «Отражение», Красная Поляна.</p>
        </aside>
      </div>
    </div>
  </section>
                ...
                <div className="flex -space-x-2">
                  {[1, 2, 3].map(i => (
                    <div key={i} className="w-7 h-7 rounded-full border-2 border-[#fdfbf9] bg-cream overflow-hidden">
                      <img src={`https://picsum.photos/seed/user${i + 20}/80/80`} alt="" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                    </div>
                  ))}
                </div>
...
const ForWho = () => (
  <section id="for-who" className="min-h-screen flex items-center py-12 bg-white relative overflow-hidden">
    <div className="absolute inset-y-0 left-0 w-full lg:w-1/2 z-0">
      <img src={FORWHO_IMG} alt="" className="w-full h-full object-cover object-left" referrerPolicy="no-referrer" />
  ...
  <section className="min-h-screen flex items-stretch relative overflow-hidden">
    <div className="grid lg:grid-cols-2 w-full min-h-screen">
      <div className="relative overflow-hidden min-h-[40vh] lg:min-h-screen">
        <img src={FINAL_IMG_SRC} alt="" className="absolute inset-0 w-full h-full object-cover object-[center_top]" referrerPolicy="no-referrer" />
  ...
  <footer className="bg-navy text-white/70 py-14 border-t border-white/10">
    <div className="max-w-6xl mx-auto px-6 md:px-12">
      ...
      <div className="mt-10 pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-3 text-[0.62rem] uppercase tracking-[0.24em] text-white/35">
        <p>© 2026 «Отражение»</p>
        <p>Безопасное пространство · Зрелая терапевтическая работа</p>
      </div>
    </div>
  </footer>
);
...
const HeroV4 = () => (
  <section className="min-h-screen flex items-stretch relative overflow-hidden bg-navy">
    <img src={HERO_IMG} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" referrerPolicy="no-referrer" />
...
const HeroV5 = () => (
  <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-navy">
    ...
    <div className="relative z-10 max-w-[72rem] mx-auto px-6 text-center">
      ...
      <p className="font-serif text-[clamp(1rem,2vw,1.2rem)] text-white/75 max-w-[32.5rem] mx-auto mb-5 italic leading-[1.7] font-light">О честности с собой. Двухдневный терапевтический выезд для тех, кто готов увидеть свою жизнь без иллюзий.</p>
      <div className="flex gap-4 justify-center flex-wrap mb-9">
  ...
  <footer className="relative overflow-hidden border-t border-white/8 bg-[#081026] py-14 text-white/55">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
      ...
      <div className="mt-6 flex flex-col items-center justify-between gap-3 border-t border-white/8 pt-5 text-center text-[0.62rem] uppercase tracking-[0.24em] text-white/32 md:flex-row">
        ...
        <p>Небольшая группа · Безопасное пространство · Зрелая терапевтическая работа</p>
      </div>
    </div>
  </footer>
);
  ...
  <section className="min-h-screen flex items-stretch relative overflow-hidden">
    ...
    <div className="grid lg:grid-cols-2 w-full min-h-screen">
      <div className="relative overflow-hidden">
        <img src={FINAL_IMG} alt="" className="absolute inset-0 w-full h-full object-cover" referrerPolicy="no-referrer" />
        <div className="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-r from-navy via-navy/50 lg:via-navy/20 to-navy/60 lg:to-transparent" />
      </div>
      <div className="bg-navy text-white flex items-center px-8 md:px-12 py-14">
        <div>
    ...
    <div className="max-w-6xl w-full mx-auto px-6 md:px-12">
      ...
      <div className="grid lg:grid-cols-[1fr_1fr] gap-10 items-center">
        <div className="aspect-[4/5] overflow-hidden rounded-sm bg-navy">
          <img src={FINAL_IMG} alt="" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
        </div>
        <div>
...
const FinalV5 = ({ onOpenModal }: any) => (
  <section className="min-h-screen flex items-center relative overflow-hidden py-12 bg-[linear-gradient(135deg,#efe4d4_0%,#f8f3ec_42%,#ede2d1_100%)]">
    ...
    <div className="absolute inset-y-0 left-0 w-full lg:w-[44%] z-0">
      <img src={FINAL_IMG} alt="" className="w-full h-full object-cover object-left lg:object-[center_top]" referrerPolicy="no-referrer" />
...
const ResultsV4 = () => (
  <section className="min-h-screen flex items-center py-12 bg-navy text-white relative overflow-hidden">
    <img src={RES_BG} alt="" className="absolute inset-0 w-full h-full object-cover object-center opacity-25" referrerPolicy="no-referrer" />
    ...
    <div className="max-w-6xl w-full mx-auto px-6 md:px-12">
      ...
      <div className="grid lg:grid-cols-[1fr_1fr] gap-10 items-center">
        <div className="relative aspect-[4/5] overflow-hidden rounded-[1.5rem] bg-navy">
          <img src={FORWHO_IMG} alt="" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
          <div className="absolute inset-0 bg-gradient-to-t from-navy/50 to-transparent" />
        </div>
        <div>
          <span className="text-[0.68rem] uppercase tracking-[0.3em] text-brown font-medium block mb-3">Для кого</span>
